...
CREATE TABLE `cities` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_cities_provinces_1` (`province_id`),
  CONSTRAINT `fk_cities_provinces_1` FOREIGN KEY (`province_id`) REFERENCES `provinces` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `cities` VALUES ('1', 'Masnsfield', '1');
COMMIT;
...
CREATE TABLE `clients` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_clients_cities_1` (`city_id`),
  KEY `fk_clients_companies_1` (`company_id`),
  CONSTRAINT `fk_clients_companies_1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`),
  CONSTRAINT `fk_clients_cities_1` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `clients` VALUES ('1', 'dddd', 'ddd', 'Mr.', null, null, '1', null, '1');
COMMIT;
...
CREATE TABLE `companies` (
  ...
  `city_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_companies_cities_1` (`city_id`),
  CONSTRAINT `fk_companies_cities_1` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `companies` VALUES ('1', 'fake', 'fakew address', '02048', '1');
COMMIT;
...
CREATE TABLE `countries` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `iso_2` (`iso2`),
  UNIQUE KEY `iso_3` (`iso3`)
...
-- ----------------------------
BEGIN;
INSERT INTO `countries` VALUES ('1', 'United States of America', 'USA', 'USA');
COMMIT;

-- ----------------------------
--  Table structure for `country_t`
-- ----------------------------
...
CREATE TABLE `dept_emp` (
  ...
  CONSTRAINT `dept_emp_ibfk_1` FOREIGN KEY (`emp_no`) REFERENCES `employees` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `dept_manager` (
  ...
  CONSTRAINT `dept_manager_ibfk_1` FOREIGN KEY (`emp_no`) REFERENCES `employees` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `employees` VALUES ('1', '1983-09-05', 'ted', 'celestin', 'M', '2015-09-09', 'ted', '7c4a8d09ca3762af61e59520943dc26494f8941b');
COMMIT;
...
CREATE TABLE `projects` (
  ...
  `name` varchar(255) DEFAULT NULL,
  `status` enum('active','cancelled','on hold','potential','production','completed') DEFAULT NULL,
  `project_manager_id` int(11) DEFAULT NULL,
  `priority` varchar(255) DEFAULT NULL,
  `project_notes` longtext,
  `modified_date` timestamp NULL DEFAULT NULL,
  `client_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_projects_employees_created` (`created_by`),
  KEY `fk_projects_employees_PM` (`project_manager_id`),
  KEY `fk_projects_clients_1` (`client_id`),
  CONSTRAINT `fk_projects_clients_1` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`),
  CONSTRAINT `fk_projects_employees_created` FOREIGN KEY (`created_by`) REFERENCES `employees` (`id`),
  CONSTRAINT `fk_projects_employees_PM` FOREIGN KEY (`project_manager_id`) REFERENCES `employees` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `projects` VALUES ('3', '1', '2015-10-01 00:00:00', '233335.00', '2015-10-08 00:00:00', '2015-10-30 00:00:00', '2015-10-23 00:00:00', 'LOTV', 'active', '1', null, null, '2015-10-16 00:00:00', null);
COMMIT;
...
CREATE TABLE `provinces` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_provinces_countries_1` (`country_id`),
  CONSTRAINT `fk_provinces_countries_1` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `provinces` VALUES ('1', 'massachussetts', '1');
COMMIT;
...
CREATE TABLE `salaries` (
  ...
  KEY `emp_no` (`emp_no`),
  CONSTRAINT `salaries_ibfk_1` FOREIGN KEY (`emp_no`) REFERENCES `employees` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `timesheets` (
  ...
  `timespent` decimal(10,2) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_timesheets_projects_1` (`projectid`),
  KEY `fk_timesheets_employees_1` (`employee_id`),
  CONSTRAINT `fk_timesheets_employees_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`),
  CONSTRAINT `fk_timesheets_projects_1` FOREIGN KEY (`projectid`) REFERENCES `projects` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `timesheets` VALUES ('6', '3', '1', 'volume', '3', null, '2015-10-14 00:00:00', '3.50');
COMMIT;
...
CREATE TABLE `titles` (
  ...
  KEY `emp_no` (`emp_no`),
  CONSTRAINT `titles_ibfk_1` FOREIGN KEY (`emp_no`) REFERENCES `employees` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
